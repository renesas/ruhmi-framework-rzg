...
#define MEM_ALLOC_BY_RUNTIME_() defined(MERA_DRP_RUNTIME) || defined(ETHOS_U55_RUNTIME)
#define MEM_ALLOC_BY_RUNTIME MEM_ALLOC_BY_RUNTIME_()
...
#define DISABLE_TVM_RUNTIME_() defined(DISABLE_TVM_RUNTIME)
#define ENABLE_TVM_RUNTIME !DISABLE_TVM_RUNTIME_()
...
#ifdef MEM_ALLOC_BY_RUNTIME
  std::shared_ptr<Runtime> buffer_mgmt_rt;
#endif /* MEM_ALLOC_BY_RUNTIME */
  // Dynamic outputs
